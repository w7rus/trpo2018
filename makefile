...
app: $(QZ_F_MAIN).o $(QZ_F_CHDIR).o $(QZ_F_CFILE).o $(QZ_F_CRBUF).o $(QZ_F_OFILE).o $(QZ_F_WTBUF).o $(QZ_F_PRTLST).o $(QZ_F_ADDLSTE).o $(QZ_F_DTEXTR).o $(QZ_F_DTEXCNG).o $(QZ_F_DTCMP).o
	$(GCC) $(PATH_BUILD)$(QZ_F_MAIN).o $(PATH_BUILD)$(QZ_F_CHDIR).o $(PATH_BUILD)$(QZ_F_CFILE).o $(PATH_BUILD)$(QZ_F_CRBUF).o $(PATH_BUILD)$(QZ_F_OFILE).o $(PATH_BUILD)$(QZ_F_WTBUF).o $(PATH_BUILD)$(QZ_F_PRTLST).o $(PATH_BUILD)$(QZ_F_ADDLSTE).o $(PATH_BUILD)$(QZ_F_DTEXTR).o $(PATH_BUILD)$(QZ_F_DTEXCNG).o $(PATH_BUILD)$(QZ_F_DTCMP).o -o $(PATH_OUT)quiz_runner.exe
